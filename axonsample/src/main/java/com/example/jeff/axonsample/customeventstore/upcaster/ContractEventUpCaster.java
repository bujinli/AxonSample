...
public class ContractEventUpCaster extends SingleEventUpcaster {
  ...
  private static List<SameEventUpCaster> upCasters =
      Arrays.asList(new ContractCreatedEventUpCaster(), new ContractUpdatedEventUpCaster());
  ...
  protected IntermediateEventRepresentation doUpcast(
    ...
    SameEventUpCaster upCaster =
        upCasters.stream().filter(o -> o.canUpcast(intermediateRepresentation)).findAny()
